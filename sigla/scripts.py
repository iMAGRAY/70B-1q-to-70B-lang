...
def ingest(json_file: str, index_path: str, model: str, factory: str, link_neighbors: int):
    try:
...
def update_capsules(json_file: str, index_path: str, link_neighbors: int) -> None:
...
def main():
    ...
    if args.cmd == "ingest":
        ingest(args.json_file, args.index_path, args.model, args.factory, args.link)
    elif args.cmd == "update":
        update_capsules(args.json_file, args.index_path, args.link)
